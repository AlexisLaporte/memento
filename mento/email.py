...
def send_invite_email(to_email: str, to_name: str, project_title: str,
    ...
    resend.Emails.send({
        "from": f"Mento <{from_email}>",
        "to": [to_email],
        "subject": f"You've been invited to {project_title} on Mento",
        "html": f"""
        <div style="font-family: -apple-system, system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 0;">
            ...
            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                {invited_by} has invited you to access the <strong>{project_title}</strong> documentation on Mento.
            </p>
            <a href="{project_url}"
